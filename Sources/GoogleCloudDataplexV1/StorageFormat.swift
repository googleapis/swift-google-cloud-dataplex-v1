  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let json = CodingKeys(stringValue: "json")
    static let iceberg = CodingKeys(stringValue: "iceberg")
  ...
  public enum Format: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .orc: return try container.encode("ORC")
      ...
      case .tfrecord: return try container.encode("TFRECORD")
  ...
  public enum CompressionFormat: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .bzip2: return try container.encode("BZIP2")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
