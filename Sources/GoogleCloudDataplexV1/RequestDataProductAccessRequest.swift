  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let changeRequest = CodingKeys(stringValue: "changeRequest")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.changeRequest = try container.decodeIfPresent(ChangeRequest.self, forKey: .changeRequest)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.changeRequest, forKey: .changeRequest)
