...
public struct CreateEncryptionConfigRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.dataplex.v1.EncryptionConfig]: <doc:EncryptionConfig>
  public var encryptionConfigId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateEncryptionConfigRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.CreateEncryptionConfigRequest"
  }
