...
/// List zones response.
public struct ListZonesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListZonesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListZonesResponse().with { $0.zones = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Zone].self, forKey: .zones) {
      self.zones = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListZonesResponse"
  }
