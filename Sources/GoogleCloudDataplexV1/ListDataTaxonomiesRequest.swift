...
public struct ListDataTaxonomiesRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataTaxonomiesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataTaxonomiesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListDataTaxonomiesRequest"
  }
