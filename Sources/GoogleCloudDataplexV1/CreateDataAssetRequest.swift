  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dataAssetId = CodingKeys(stringValue: "dataAssetId")
    static let dataAsset = CodingKeys(stringValue: "dataAsset")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .dataAssetId) {
      self.dataAssetId = value
    }
    self.dataAsset = try container.decodeIfPresent(DataAsset.self, forKey: .dataAsset)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.dataAssetId, forKey: .dataAssetId)
    try container.encodeIfPresent(self.dataAsset, forKey: .dataAsset)
