  ...
  Sendable
{
  ...
  public enum ChangeType: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .createEntry: return try container.encode("CREATE_ENTRY")
      case .updateEntry: return try container.encode("UPDATE_ENTRY")
      case .deleteEntry: return try container.encode("DELETE_ENTRY")
      case .createEntryLink: return try container.encode("CREATE_ENTRY_LINK")
      case .deleteEntryLink: return try container.encode("DELETE_ENTRY_LINK")
      case .createGlossary: return try container.encode("CREATE_GLOSSARY")
      case .updateGlossary: return try container.encode("UPDATE_GLOSSARY")
      case .deleteGlossary: return try container.encode("DELETE_GLOSSARY")
      case .createGlossaryCategory: return try container.encode("CREATE_GLOSSARY_CATEGORY")
      case .updateGlossaryCategory: return try container.encode("UPDATE_GLOSSARY_CATEGORY")
      case .deleteGlossaryCategory: return try container.encode("DELETE_GLOSSARY_CATEGORY")
      case .createGlossaryTerm: return try container.encode("CREATE_GLOSSARY_TERM")
      case .updateGlossaryTerm: return try container.encode("UPDATE_GLOSSARY_TERM")
      case .deleteGlossaryTerm: return try container.encode("DELETE_GLOSSARY_TERM")
      case .requestDataProductAccess: return try container.encode("REQUEST_DATA_PRODUCT_ACCESS")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
