...
public struct ListDataAttributeBindingsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataAttributeBindingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataAttributeBindingsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListDataAttributeBindingsRequest"
  }
