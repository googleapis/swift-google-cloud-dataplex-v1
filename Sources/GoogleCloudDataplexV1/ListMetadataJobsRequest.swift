...
public struct ListMetadataJobsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMetadataJobsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMetadataJobsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListMetadataJobsRequest"
  }
