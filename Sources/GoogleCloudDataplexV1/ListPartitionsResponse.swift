  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListPartitionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPartitionsResponse().with { $0.partitions = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Partition].self, forKey: .partitions) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListPartitionsResponse"
  }
