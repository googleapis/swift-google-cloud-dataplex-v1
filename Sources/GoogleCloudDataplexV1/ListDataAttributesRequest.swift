...
public struct ListDataAttributesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataAttributesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataAttributesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListDataAttributesRequest"
  }
