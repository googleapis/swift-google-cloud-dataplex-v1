...
public struct StorageAccess: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let read = CodingKeys(stringValue: "read")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(StorageAccess.AccessMode.self, forKey: .read) {
      self.read = value
    }
