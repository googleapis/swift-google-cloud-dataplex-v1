...
public struct CreateDataAttributeRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = CreateDataAttributeRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.CreateDataAttributeRequest"
  }
