...
/// List lakes response.
public struct ListLakesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// Lakes under the given parent location.
  public var lakes: [Lake] = []
  ...
  /// Initialize a new instance of `ListLakesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLakesResponse().with { $0.lakes = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let lakes = CodingKeys(stringValue: "lakes")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Lake].self, forKey: .lakes) {
      self.lakes = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListLakesResponse"
  }
