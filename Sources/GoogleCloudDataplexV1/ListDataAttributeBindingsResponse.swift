...
public struct ListDataAttributeBindingsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataAttributeBindingsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataAttributeBindingsResponse().with { $0.dataAttributeBindings = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dataAttributeBindings = CodingKeys(stringValue: "dataAttributeBindings")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [DataAttributeBinding].self, forKey: .dataAttributeBindings)
    {
      self.dataAttributeBindings = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListDataAttributeBindingsResponse"
  }
