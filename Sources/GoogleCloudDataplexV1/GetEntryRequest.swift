...
/// Get Entry request.
public struct GetEntryRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// View.**
  public var view: EntryView = EntryView()
  ...
  /// Initialize a new instance of `GetEntryRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetEntryRequest().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(EntryView.self, forKey: .view) {
      self.view = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.GetEntryRequest"
  }
