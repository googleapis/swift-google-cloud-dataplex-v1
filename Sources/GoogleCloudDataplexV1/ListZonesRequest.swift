...
/// List zones request.
public struct ListZonesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListZonesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListZonesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListZonesRequest"
  }
