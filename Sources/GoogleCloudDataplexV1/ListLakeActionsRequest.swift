...
public struct ListLakeActionsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListLakeActionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLakeActionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListLakeActionsRequest"
  }
