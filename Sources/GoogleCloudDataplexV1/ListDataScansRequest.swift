...
public struct ListDataScansRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataScansRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataScansRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListDataScansRequest"
  }
