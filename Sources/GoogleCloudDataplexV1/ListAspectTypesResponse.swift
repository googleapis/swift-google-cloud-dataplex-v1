...
public struct ListAspectTypesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// AspectTypes under the given parent location.
  public var aspectTypes: [AspectType] = []
  ...
  /// Initialize a new instance of `ListAspectTypesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAspectTypesResponse().with { $0.aspectTypes = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AspectType].self, forKey: .aspectTypes) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListAspectTypesResponse"
  }
