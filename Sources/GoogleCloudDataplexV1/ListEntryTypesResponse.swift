...
public struct ListEntryTypesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// EntryTypes under the given parent location.
  public var entryTypes: [EntryType] = []
  ...
  /// Initialize a new instance of `ListEntryTypesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEntryTypesResponse().with { $0.entryTypes = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([EntryType].self, forKey: .entryTypes) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListEntryTypesResponse"
  }
...
extension ListEntryTypesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [EntryType] {
