...
public struct ListDataTaxonomiesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataTaxonomiesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataTaxonomiesResponse().with { $0.dataTaxonomies = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dataTaxonomies = CodingKeys(stringValue: "dataTaxonomies")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListDataTaxonomiesResponse"
  }
