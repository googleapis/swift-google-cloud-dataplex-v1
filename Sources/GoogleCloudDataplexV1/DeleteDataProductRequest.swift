...
public struct DeleteDataProductRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteDataProductRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteDataProductRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.DeleteDataProductRequest"
  }
