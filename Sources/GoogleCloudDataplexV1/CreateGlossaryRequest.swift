...
public struct CreateGlossaryRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var glossaryId: Swift.String = Swift.String()

  /// Required. The Glossary to create.
  public var glossary: Glossary? = nil
  ...
  /// Initialize a new instance of `CreateGlossaryRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateGlossaryRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let glossaryId = CodingKeys(stringValue: "glossaryId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .glossaryId) {
      self.glossaryId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.glossaryId, forKey: .glossaryId)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.CreateGlossaryRequest"
  }
