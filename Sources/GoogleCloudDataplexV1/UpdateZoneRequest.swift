...
/// Update zone request.
public struct UpdateZoneRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateZoneRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateZoneRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.UpdateZoneRequest"
  }
