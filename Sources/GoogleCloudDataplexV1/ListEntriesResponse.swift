...
public struct ListEntriesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListEntriesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEntriesResponse().with { $0.entries = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Entry].self, forKey: .entries) {
      self.entries = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListEntriesResponse"
  }
