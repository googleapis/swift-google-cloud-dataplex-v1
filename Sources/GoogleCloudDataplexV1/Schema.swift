  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let partitionFields = CodingKeys(stringValue: "partitionFields")
    static let partitionStyle = CodingKeys(stringValue: "partitionStyle")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.partitionFields, forKey: .partitionFields)
    try container.encode(self.partitionStyle, forKey: .partitionStyle)
  ...
  public enum Type_: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .byte: return try container.encode("BYTE")
      ...
      case .decimal: return try container.encode("DECIMAL")
      ...
      case .date: return try container.encode("DATE")
  ...
  public enum Mode: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .nullable: return try container.encode("NULLABLE")
      case .repeated: return try container.encode("REPEATED")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
  ...
  public enum PartitionStyle: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      var container = encoder.singleValueContainer()
      switch self {
      case .unspecified: return try container.encode("PARTITION_STYLE_UNSPECIFIED")
      case .hiveCompatible: return try container.encode("HIVE_COMPATIBLE")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
