...
public struct ListDataProductsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The data products for the requested filter criteria.
  public var dataProducts: [DataProduct] = []
  ...
  /// Initialize a new instance of `ListDataProductsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataProductsResponse().with { $0.dataProducts = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dataProducts = CodingKeys(stringValue: "dataProducts")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([DataProduct].self, forKey: .dataProducts) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.dataProducts, forKey: .dataProducts)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListDataProductsResponse"
  }
...
extension ListDataProductsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [DataProduct] {
