...
public struct ListZoneActionsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListZoneActionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListZoneActionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListZoneActionsRequest"
  }
