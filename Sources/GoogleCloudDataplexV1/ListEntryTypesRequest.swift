...
public struct ListEntryTypesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListEntryTypesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEntryTypesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListEntryTypesRequest"
  }
