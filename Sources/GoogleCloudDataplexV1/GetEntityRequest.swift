...
public struct GetEntityRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Defaults to `BASIC`.
  public var view: GetEntityRequest.EntityView = GetEntityRequest.EntityView()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `GetEntityRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetEntityRequest().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(GetEntityRequest.EntityView.self, forKey: .view) {
      self.view = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.GetEntityRequest"
  }
