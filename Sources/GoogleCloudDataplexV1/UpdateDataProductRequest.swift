...
public struct UpdateDataProductRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateDataProductRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDataProductRequest().with { $0.dataProduct = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.UpdateDataProductRequest"
  }
