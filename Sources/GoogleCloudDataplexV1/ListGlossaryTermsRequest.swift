...
public struct ListGlossaryTermsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGlossaryTermsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGlossaryTermsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListGlossaryTermsRequest"
  }
