...
public struct ListEncryptionConfigsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of EncryptionConfigs under the given parent location.
  public var encryptionConfigs: [EncryptionConfig] = []
  ...
  /// Initialize a new instance of `ListEncryptionConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEncryptionConfigsResponse().with { $0.encryptionConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let encryptionConfigs = CodingKeys(stringValue: "encryptionConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [EncryptionConfig].self, forKey: .encryptionConfigs)
    {
      self.encryptionConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.encryptionConfigs, forKey: .encryptionConfigs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListEncryptionConfigsResponse"
  }
