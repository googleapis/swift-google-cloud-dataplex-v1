...
public struct ListEntryGroupsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListEntryGroupsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEntryGroupsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListEntryGroupsRequest"
  }
