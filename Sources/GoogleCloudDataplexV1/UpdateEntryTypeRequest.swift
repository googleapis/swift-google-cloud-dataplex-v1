...
public struct UpdateEntryTypeRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateEntryTypeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateEntryTypeRequest().with { $0.entryType = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.UpdateEntryTypeRequest"
  }
