...
public struct ListMetadataJobsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Metadata jobs under the specified parent location.
  public var metadataJobs: [MetadataJob] = []
  ...
  /// Initialize a new instance of `ListMetadataJobsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMetadataJobsResponse().with { $0.metadataJobs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let metadataJobs = CodingKeys(stringValue: "metadataJobs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([MetadataJob].self, forKey: .metadataJobs) {
      self.metadataJobs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.metadataJobs, forKey: .metadataJobs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListMetadataJobsResponse"
  }
...
extension ListMetadataJobsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [MetadataJob] {
    return self.metadataJobs
  }
