  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let metadataFeeds = CodingKeys(stringValue: "metadataFeeds")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([MetadataFeed].self, forKey: .metadataFeeds) {
      self.metadataFeeds = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.metadataFeeds, forKey: .metadataFeeds)
