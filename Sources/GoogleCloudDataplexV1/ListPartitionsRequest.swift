...
public struct ListPartitionsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPartitionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPartitionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataplex.v1.ListPartitionsRequest"
  }
